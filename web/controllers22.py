...
def register():
    ...
    try:
        newUser = Usuario(name=nombre, phone=telefono, adress=direccion, username=nombre_usuario,
...
def registrar_producto():
    ...
    try:
        newProduct = Producto(codigo_p=codigo, usuario_p=usuario, nombre=nombre, precio=precio,
...
def registrar_compra():
    ...
    try:
        newPurchase = Compra(codigo_p=codigo_p, usuario_c=comprador, usuario_v=vendedor)
